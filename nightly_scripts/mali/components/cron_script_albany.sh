...
LOG_FILE=$BASE_DIR/nightly_log_${MACHINE_HOST}_Albany.txt
...
# cmake --version
eval "env TEST_DIRECTORY=$BASE_DIR SCRIPT_DIRECTORY=$BASE_DIR ctest -VV -S $SCRIPT_DIR/components/${MACHINE_HOST}/ctest_nightly_albany.cmake" > $LOG_FILE 2>&1
