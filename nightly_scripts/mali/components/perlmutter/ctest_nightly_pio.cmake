...
# Begin User inputs:
set (CTEST_SITE "pm-cpu" ) # Use cori-knl to match E3SM
...
if (DOWNLOAD_PIO)
  ...
  if (NOT EXISTS "${CTEST_SOURCE_DIRECTORY}/PIO")
    execute_process (COMMAND "${CTEST_GIT_COMMAND}" 
      clone ${PIO_REPOSITORY_LOCATION} -b main ${CTEST_SOURCE_DIRECTORY}/PIO
...
# "-DCMAKE_Fortran_FLAGS=-O2 -fallow-argument-mismatch -DHAVE_NANOTIME -DBIT64 -DHAVE_VPRINTF -DHAVE_BACKTRACE -DHAVE_SLASHPROC -DHAVE_COMM_F2C -DHAVE_TIMES -DHAVE_GETTIMEOFDAY"
  )
